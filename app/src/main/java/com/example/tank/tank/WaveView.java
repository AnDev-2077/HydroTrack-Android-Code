...
public class WaveView extends LinearLayout {
    ...
    public WaveView(Context context, AttributeSet attrs) {
        ...
        final TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, R.styleable.WaveView, R.style.WaveViewStyle  , 0);
        mAboveWaveColor = attributes.getColor(com.example.tank.R.styleable.WaveView_above_wave_color, DEFAULT_ABOVE_WAVE_COLOR);
